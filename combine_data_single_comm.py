...
def main(community):
    ...
    dataset_folder = f'dataset_{community}'
    all_data_dict = {
        'answered_post': [], 
        'all_answers': [], 
        'all_questions': [], 
    ...
    answered_post.to_csv(f'{dataset_folder}/questions_with_answer.csv', index=None)
    all_answers.to_csv(f'{dataset_folder}/answers.csv', index=None)
    all_questions.to_csv(f'{dataset_folder}/questions.csv', index=None)
    users.to_csv(f'{dataset_folder}/users.csv', index=None)
    comments.to_csv(f'{dataset_folder}/comments.csv', index=None)
    postlinks.to_csv(f'{dataset_folder}/postlinks.csv', index=None)
    tags.to_csv(f'{dataset_folder}/tags.csv', index=None)
